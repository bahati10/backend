...
describe("Blogs API", () => {
    ...
    describe("msgs", () => {
        it("Should not GET single Message", function (done) {

            chai.request(server)
                .get("/api/messages/63e3fa9bed8523be0").then(response => {
                    response.should.have.status(500);
                    expect(response).to.be.a("object");
                    done();
                })
    ...
    describe("msgs", () => {
        it("Should not UPDATE single Message", function (done) {

            chai.request(server)
                .patch("/api/messages/63e3fa9bed8523be086b107f").then(response => {
